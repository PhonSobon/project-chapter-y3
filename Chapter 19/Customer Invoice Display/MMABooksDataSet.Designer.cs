...
namespace Customer_Invoice_Display.MMABooksDataSetTableAdapters {
...
SELECT CustomerID, Name, Address, City, State, ZipCode FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Customer_Invoice_Display.Properties.Settings.Default.MMABooksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT CustomerID, Name, Address, City, State, ZipCode FROM dbo.Customers WHERE C" +
...
SELECT InvoiceID, CustomerID, InvoiceDate, ProductTotal, SalesTax, Shipping, InvoiceTotal FROM Invoices WHERE (InvoiceID = @InvoiceID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT InvoiceID, CustomerID, InvoiceDate, ProductTotal, SalesTax, Shipping, Invo" +
                "iceTotal FROM dbo.Invoices WHERE CustomerID = @CustomerID";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustomerID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
