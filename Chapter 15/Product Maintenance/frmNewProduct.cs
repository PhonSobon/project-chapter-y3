...
namespace Product_Maintenance
{
    public partial class frmNewProduct : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                if (rbBook.Checked)
                    product = new Book(txtCode.Text, txtDescription.Text, txtAuthorOrVersion.Text, Convert.ToDecimal(txtPrice.Text));
                else
                    product = new Software(txtCode.Text, txtDescription.Text, txtAuthorOrVersion.Text, Convert.ToDecimal(txtPrice.Text));
                this.Close();
            }
        }
