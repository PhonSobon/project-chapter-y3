...
namespace Product_Maintenance.MMABooksDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Products] WHERE (([ProductCode] = @Original_ProductCode) AND ([Descr" +
                "iption] = @Original_Description) AND ([UnitPrice] = @Original_UnitPrice))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Products] ([ProductCode], [Description], [UnitPrice]) VALUES (@Produ" +
                "ctCode, @Description, @UnitPrice);\r\nSELECT ProductCode, Description, UnitPrice F" +
                "ROM Products WHERE (ProductCode = @ProductCode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Products] SET [ProductCode] = @ProductCode, [Description] = @Description, [UnitPrice] = @UnitPrice WHERE (([ProductCode] = @Original_ProductCode) AND ([Description] = @Original_Description) AND ([UnitPrice] = @Original_UnitPrice));
SELECT ProductCode, Description, UnitPrice FROM Products WHERE (ProductCode = @ProductCode)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Product_Maintenance.Properties.Settings.Default.MMABooksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductCode, Description, UnitPrice FROM Products";
